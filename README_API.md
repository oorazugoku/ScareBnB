...
* Request
  * Method: DELETE
  * URL: spots/:spotId || spots/:spotId/:userId
  * Body: none
...
* Request
  * Method: PUT
  * URL: reviews/:reviewId || users/:userId/reviews/:reviewId
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: DELETE
  * URL: reviews/:reviewId || reviews/:reviewId/:userId
  * Body: none
...
* Request
  * Method: POST
  * URL: spots/:spotId/bookings || spots/:spotId/bookings/:userId
  * Body:
...
* Request
  * Method: DELETE
  * URL: images/:imageId || images/:imageId/:userId
  * Body: none
